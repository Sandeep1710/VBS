...
<x-card title="Description & Image">
    <div class="grid gap-4">
        ...
        <div>
            <x-label for="description" value="Long description (HTML allowed)" />
            <textarea name="description" id="description" rows="6" class="input font-mono text-xs">{{ old('description', optional($product)->description) }}</textarea>
        </div>
