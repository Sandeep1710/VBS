...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['general', 'site_tagline', "Navi Mumbai's #1 battery delivery · Same or next-day across Mumbai metro", 'string', 'Site Tagline', true],
            ...
            ['order', 'default_delivery_charge', '99', 'integer', 'Default Delivery Charge (₹) — Zone A pincodes'],
            ['order', 'free_delivery_above', '12000', 'integer', 'Free Delivery Above (₹) — only premium 100Ah+ orders qualify'],
            ...
            ['seo', 'default_meta_title', 'Buy Car Batteries Online in Mumbai — Same or Next-day Delivery', 'string', 'Default Meta Title'],
            ['seo', 'default_meta_description', "Mumbai's trusted battery delivery service. Buy genuine Exide and Amaron car batteries with same or next-day delivery, free installation and old battery exchange across Mumbai, Thane and Navi Mumbai.", 'text', 'Default Meta Description'],
